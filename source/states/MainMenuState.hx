...
class MainMenuState extends MusicBeatState
{
	...
	var optionShit:Array<String> = ['story mode', 'freeplay', 'options', 'mods', 'replays'];
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(5, FlxG.height - 18, 0, (utilities.Options.getData("watermarks") ? TitleState.version : "v0.2.7.1") + " Ported By Hero, Raiden and kamodrip", 16);
